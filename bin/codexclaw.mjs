...
function printHelp() {
  process.stdout.write(
    [
      "tele-codex - minimal Codex/OpenAI API/Qwen/Ollama/OpenRouter/Groq + Telegram bridge",
      "",
      "Usage:",
      ...
      "",
      "Notes:",
      "  - onboard: provider setup (OAuth/Ollama/OpenAI API/OpenRouter/Groq) + model select + telegram setup + optional Notion/web/scheduler skill setup",
