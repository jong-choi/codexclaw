...
function printHelp() {
  process.stdout.write(
    [
      "tele-codex - minimal Codex/Qwen/Ollama/OpenRouter/Groq + Telegram bridge",
      "",
      "Usage:",
      ...
      "",
      "Notes:",
      "  - onboard: provider setup (OAuth/Ollama/OpenRouter/Groq) + model select + telegram setup + optional Notion/web/scheduler skill setup",
